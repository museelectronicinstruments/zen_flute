...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "guitarMIDI.dsp");
		...
		m->declare("library_path6", "/libraries/noises.lib");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("bend", &fHslider3, FAUSTFLOAT(0.0f), FAUSTFLOAT(-2.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.00999999978f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow5 = std::min<float>(1.0f, (float(fHslider4) + float(fButton0)));
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			fRec25[0] = (fSlow1 + (fConst4 * fRec25[1]));
			fVec0[0] = fSlow5;
			float fTemp0 = float(((fSlow5 == fVec0[1]) | iSlow6));
			fRec26[0] = ((fSlow4 * (1.0f - (0.999000013f * fTemp0))) + (0.999000013f * (fTemp0 * fRec26[1])));
			float fTemp1 = ((fSlow3 / fRec26[0]) + -0.100000001f);
			float fTemp2 = (fConst2 * ((1.0f - fRec25[0]) * fTemp1));
			...
			fRec22[0] = (((((fRec2[((IOTA0 - (iTemp5 + 1)) & 2047)] * fTemp8) * fTemp10) * fTemp12) * fTemp14) + (fTemp15 * ((((((fRec2[((IOTA0 - (iTemp16 + 1)) & 2047)] * fTemp17) * fTemp18) * fTemp19) + (0.5f * (((fTemp7 * fRec2[((IOTA0 - (iTemp20 + 1)) & 2047)]) * fTemp21) * fTemp22))) + (0.166666672f * ((fTemp23 * fRec2[((IOTA0 - (iTemp24 + 1)) & 2047)]) * fTemp25))) + (0.0416666679f * (fTemp26 * fRec2[((IOTA0 - (iTemp27 + 1)) & 2047)])))));
			fRec27[0] = ((0.949999988f * fRec22[1]) + (0.0500000007f * fRec27[1]));
			float fRec23 = fRec27[0];
			fRec29[0] = fRec0[1];
			fRec30[(IOTA0 & 2047)] = (-1.0f * (0.997843683f * ((0.699999988f * fRec29[2]) + (0.150000006f * (fRec29[1] + fRec29[3])))));
			float fTemp28 = (fConst2 * (fRec25[0] * fTemp1));
			...
			fVec1[0] = (((((fRec30[((IOTA0 - (iTemp31 + 2)) & 2047)] * fTemp34) * fTemp36) * fTemp38) * fTemp40) + (fTemp41 * ((((((fRec30[((IOTA0 - (iTemp42 + 2)) & 2047)] * fTemp43) * fTemp44) * fTemp45) + (0.5f * (((fTemp33 * fRec30[((IOTA0 - (iTemp46 + 2)) & 2047)]) * fTemp47) * fTemp48))) + (0.166666672f * ((fTemp49 * fRec30[((IOTA0 - (iTemp50 + 2)) & 2047)]) * fTemp51))) + (0.0416666679f * (fTemp52 * fRec30[((IOTA0 - (iTemp53 + 2)) & 2047)])))));
			iRec32[0] = ((1103515245 * iRec32[1]) + 12345);
			float fTemp54 = std::tan((fSlow8 * fRec26[0]));
			float fTemp55 = (1.0f / fTemp54);
			float fTemp56 = (((fTemp55 + 1.41421354f) / fTemp54) + 1.0f);
			fRec31[0] = ((4.65661287e-10f * float(iRec32[0])) - (((fRec31[2] * (((fTemp55 + -1.41421354f) / fTemp54) + 1.0f)) + (2.0f * (fRec31[1] * (1.0f - (1.0f / mydsp_faustpower2_f(fTemp54)))))) / fTemp56));
			iRec33[0] = (((iRec33[1] + (iRec33[1] > 0)) * (fSlow5 <= fVec0[1])) + (fSlow5 > fVec0[1]));
			float fTemp57 = (float(iRec33[0]) / std::max<float>(1.0f, (fConst6 * mydsp_faustpower2_f((1.0f - (fSlow9 * fRec26[0]))))));
			float fTemp58 = (fSlow7 * (((fRec31[2] + (fRec31[0] + (2.0f * fRec31[1]))) * std::max<float>(0.0f, std::min<float>(fTemp57, (2.0f - fTemp57)))) / fTemp56));
			fVec2[0] = (fVec1[1] + fTemp58);
			fRec28[(IOTA0 & 2047)] = ((0.949999988f * fVec2[1]) + (0.0500000007f * fRec28[((IOTA0 - 1) & 2047)]));
			float fRec24 = (((((fTemp8 * fTemp10) * fTemp12) * fTemp14) * fRec28[((IOTA0 - iTemp5) & 2047)]) + (fTemp15 * ((((((fTemp17 * fTemp18) * fTemp19) * fRec28[((IOTA0 - iTemp16) & 2047)]) + (0.5f * (((fTemp7 * fTemp21) * fTemp22) * fRec28[((IOTA0 - iTemp20) & 2047)]))) + (0.166666672f * ((fTemp23 * fTemp25) * fRec28[((IOTA0 - iTemp24) & 2047)]))) + (0.0416666679f * (fTemp26 * fRec28[((IOTA0 - iTemp27) & 2047)])))));
			fRec19[0] = fRec23;
			float fRec20 = (fTemp58 + fRec19[1]);
			float fRec21 = fRec24;
			fRec16[(IOTA0 & 2047)] = fRec20;
			float fRec17 = (((((fTemp34 * fTemp36) * fTemp38) * fTemp40) * fRec16[((IOTA0 - (iTemp31 + 1)) & 2047)]) + (fTemp41 * ((((((fTemp43 * fTemp44) * fTemp45) * fRec16[((IOTA0 - (iTemp42 + 1)) & 2047)]) + (0.5f * (((fTemp33 * fTemp47) * fTemp48) * fRec16[((IOTA0 - (iTemp46 + 1)) & 2047)]))) + (0.166666672f * ((fTemp49 * fTemp51) * fRec16[((IOTA0 - (iTemp50 + 1)) & 2047)]))) + (0.0416666679f * (fTemp52 * fRec16[((IOTA0 - (iTemp53 + 1)) & 2047)])))));
			fRec18[0] = fRec21;
			fRec15[0] = fRec18[1];
			...
			fRec0[0] = fRec3;
			float fRec1 = fRec5;
			float fTemp59 = (fSlow0 * fRec1);
			output0[i0] = FAUSTFLOAT(fTemp59);
			output1[i0] = FAUSTFLOAT(fTemp59);
			iRec10[1] = iRec10[0];
			IOTA0 = (IOTA0 + 1);
			fRec25[1] = fRec25[0];
			fVec0[1] = fVec0[0];
	...
	#define FAUST_FILE_NAME "guitarMIDI.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("guitar/[0]midi/freq", fHslider2, 440.0f, 50.0f, 1000.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("guitar/[0]midi/bend", fHslider3, 0.0f, -2.0f, 2.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("guitar/[0]midi/gain", fHslider5, 0.80000000000000004f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("guitar/[0]midi/sustain", fHslider4, 0.0f, 0.0f, 1.0f, 1.0f);
	FAUST_ADDBUTTON("guitar/gate", fButton0);
	FAUST_ADDHORIZONTALSLIDER("guitar/outGain", fHslider0, 0.5f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("guitar/pluckPosition", fHslider1, 0.80000000000000004f, 0.0f, 1.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, freq, "guitar/[0]midi/freq", fHslider2, 440.0f, 50.0f, 1000.0f, 0.01f) \
		p(HORIZONTALSLIDER, bend, "guitar/[0]midi/bend", fHslider3, 0.0f, -2.0f, 2.0f, 0.01f) \
		p(HORIZONTALSLIDER, gain, "guitar/[0]midi/gain", fHslider5, 0.80000000000000004f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, sustain, "guitar/[0]midi/sustain", fHslider4, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(BUTTON, gate, "guitar/gate", fButton0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, outGain, "guitar/outGain", fHslider0, 0.5f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, pluckPosition, "guitar/pluckPosition", fHslider1, 0.80000000000000004f, 0.0f, 1.0f, 0.01f) \
...
guitarMIDI::guitarMIDI() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void guitarMIDI::updateImp(void)
{
#if MIDICTRL
...
void guitarMIDI::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void guitarMIDI::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float guitarMIDI::getParamValue(const std::string& path)
{
