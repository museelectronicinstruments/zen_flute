...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("noises_lib_version", "0.2");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("tubeLength", &fHslider7, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.00999999978f), FAUSTFLOAT(2.5f), FAUSTFLOAT(0.00999999978f));
		ui_interface->declare(&fHslider6, "2", "");
		ui_interface->addHorizontalSlider("lipsTension", &fHslider6, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00999999978f));
		ui_interface->declare(&fHslider0, "3", "");
		ui_interface->addHorizontalSlider("mute", &fHslider0, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00999999978f));
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow12 = (fConst1 * float(fHslider7));
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			iRec6[0] = 0;
			fRec13[0] = (fSlow0 + (fConst2 * fRec13[1]));
			fRec12[0] = (((1.0f - fRec13[0]) * fRec11[1]) + (fRec13[0] * fRec12[1]));
			float fRec10 = (fRec12[0] + float(iRec6[1]));
			fRec14[0] = fRec0[1];
			fRec19[0] = (fSlow2 + (fRec19[1] - std::floor((fSlow2 + fRec19[1]))));
			fRec20[0] = (fSlow3 + (fConst2 * fRec20[1]));
			iRec22[0] = ((1103515245 * iRec22[1]) + 12345);
			fRec21[0] = ((4.65661287e-10f * float(iRec22[0])) - (fSlow8 * ((fSlow9 * fRec21[2]) + (fSlow10 * fRec21[1]))));
			float fTemp0 = ((fSlow1 * ftbl0mydspSIG0[int((65536.0f * fRec19[0]))]) + (fRec20[0] * ((fSlow7 * (fRec21[2] + (fRec21[0] + (2.0f * fRec21[1])))) + 1.0f)));
			fRec23[0] = (fSlow11 + (fConst2 * fRec23[1]));
			fRec24[0] = (fSlow12 + (fConst2 * fRec24[1]));
			fRec17[0] = ((0.0299999993f * ((0.300000012f * fTemp0) - (0.850000024f * fRec14[1]))) - ((fRec17[1] * (0.0f - (1.99399996f * std::cos((fConst5 * (std::pow(4.0f, ((2.0f * fRec23[0]) + -1.0f)) / fRec24[0])))))) + (0.994009018f * fRec17[2])));
			float fTemp1 = std::max<float>(-1.0f, std::min<float>(1.0f, mydsp_faustpower2_f(fRec17[0])));
			...
			float fTemp4 = (fConst7 * fRec24[0]);
			float fTemp5 = (fTemp4 + -1.49999499f);
			int iTemp6 = int(fTemp5);
			int iTemp7 = (int(std::min<float>(fConst6, float(std::max<int>(0, iTemp6)))) + 1);
			...
			int iTemp18 = (int(std::min<float>(fConst6, float(std::max<int>(0, (iTemp6 + 1))))) + 1);
			float fTemp19 = (0.0f - fTemp11);
			float fTemp20 = (0.0f - (0.5f * fTemp13));
			float fTemp21 = (0.0f - (0.333333343f * fTemp15));
			int iTemp22 = (int(std::min<float>(fConst6, float(std::max<int>(0, (iTemp6 + 2))))) + 1);
			float fTemp23 = (0.0f - fTemp13);
			float fTemp24 = (0.0f - (0.5f * fTemp15));
			float fTemp25 = (fTemp9 * fTemp11);
			int iTemp26 = (int(std::min<float>(fConst6, float(std::max<int>(0, (iTemp6 + 3))))) + 1);
			float fTemp27 = (0.0f - fTemp15);
			float fTemp28 = (fTemp25 * fTemp13);
			int iTemp29 = (int(std::min<float>(fConst6, float(std::max<int>(0, (iTemp6 + 4))))) + 1);
	...
	#define FAUST_FILE_NAME "sax.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("brass/blower/pressure", fHslider3, 0.0f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("brass/blower/breathGain", fHslider4, 0.10000000000000001f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("brass/blower/breathCutoff", fHslider5, 2000.0f, 20.0f, 20000.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("brass/blower/vibratoFreq", fHslider2, 5.0f, 0.10000000000000001f, 10.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("brass/blower/vibratoGain", fHslider1, 0.25f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("brass/brassModel/tubeLength", fHslider7, 0.5f, 0.01f, 2.5f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("brass/brassModel/lipsTension", fHslider6, 0.5f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("brass/brassModel/mute", fHslider0, 0.5f, 0.0f, 1.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, pressure, "brass/blower/pressure", fHslider3, 0.0f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, breathGain, "brass/blower/breathGain", fHslider4, 0.10000000000000001f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, breathCutoff, "brass/blower/breathCutoff", fHslider5, 2000.0f, 20.0f, 20000.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, vibratoFreq, "brass/blower/vibratoFreq", fHslider2, 5.0f, 0.10000000000000001f, 10.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, vibratoGain, "brass/blower/vibratoGain", fHslider1, 0.25f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, tubeLength, "brass/brassModel/tubeLength", fHslider7, 0.5f, 0.01f, 2.5f, 0.01f) \
		p(HORIZONTALSLIDER, lipsTension, "brass/brassModel/lipsTension", fHslider6, 0.5f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, mute, "brass/brassModel/mute", fHslider0, 0.5f, 0.0f, 1.0f, 0.01f) \
...
sax::sax() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void sax::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void sax::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float sax::getParamValue(const std::string& path)
{
